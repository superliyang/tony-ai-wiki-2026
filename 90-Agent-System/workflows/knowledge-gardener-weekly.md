...
- `30-Playbooks/`
- `40-Projects/`
- `00-Inbox-AI/` as historical staging
- `/Users/tony/Vault/tony-wiki-space/tony-ai-working-vault/20-Review-Queue/`
- `90-Agent-System/当前状态.md`

## Writes

- `/Users/tony/Vault/tony-wiki-space/tony-ai-working-vault/40-Logs/gardener/weekly/`

## Weekly Checks

- historical `00-Inbox-AI/` 是否堆积；
- working vault `20-Review-Queue/pending/` 是否停滞；
- working vault request 是否有坏 request；
- `20-Maps/` 是否有过期入口；
- 哪些领域还是 seed；
