...
|---|---|---:|---|---|
| Daily Codex Learning Task Gate | heartbeat | 09:15 daily | `00-Inbox-AI/learning-tasks/` | 只处理 learning task gate，不替代人工判断 |
| Codex Request Quality Gate | cron | 09:25 daily | `00-Inbox-AI/codex-requests/quality-reports/` | 只检查请求质量，不移动、不发布、不提升 |
| Codex Request Consumer | heartbeat | 09:35 daily | `00-Inbox-AI/codex-requests/done/` or `failed/` | 每次最多处理一个请求 |
| Review Queue Triage | cron | 09:50 daily | `00-Inbox-AI/review-queue/triage/` | 只生成决策面板，不 accept/discard |
| Knowledge Gardener Weekly | cron | 10:30 Sunday | `00-Inbox-AI/gardener/weekly/` | 只提出清理和提升批次，不直接改 canonical notes |
