...
# Memory Review Candidates — 2026-06-09
...
- Type: review-queue backlog
- Signal: pending 96.9h，超过 72h 阈值
...
## Candidate 5: 处理积压候选 `2026-06-04-memory-review.md`
- Type: review-queue backlog
- Signal: pending 120.0h，超过 72h 阈值
- Title: Memory Review 2026-06-04

## Candidate 6: 处理积压候选 `2026-06-03-memory-review.md`
- Type: review-queue backlog
- Signal: pending 144.0h，超过 72h 阈值
- Title: Memory Review 2026-06-03

## Candidate 7: 决策停滞 — 7 天未做任何判断
- Type: idle_judge
- Detail: pending 积压 12 件，但近期无 accepted/discarded。建议花 2 分钟扫一遍 review-queue。

## Candidate 8: pending(12) 远大于 accepted(0)
